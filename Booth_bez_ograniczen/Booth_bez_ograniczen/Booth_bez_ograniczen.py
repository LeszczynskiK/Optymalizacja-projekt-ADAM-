...
#it is permitted to change learning rate and beta
...
initial_point_booth = np.array([-10, 10])

# Run ADAM optimization for Booth Function
optimal_point_booth, history_booth, variable_history_booth, iterations = adam_optimization(booth_gradient, booth, initial_point_booth)
