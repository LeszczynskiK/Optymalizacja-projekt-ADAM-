...
#it is permitted to change min and max learning rate, and beta
#max_learning_rate: Pocz¹tkowa maksymalna wartoœæ wspó³czynnika uczenia.
#min_learning_rate: Minimalna wartoœæ wspó³czynnika uczenia, do której zmierza podczas optymalizacji.
#beta1: Parametr kontroluj¹cy wspó³czynnik wyg³adzania dla œredniej pierwszego rzêdu gradientów.
#beta2: Parametr kontroluj¹cy wspó³czynnik wyg³adzania dla œredniej drugiego rzêdu gradientów.
def adam_optimization(gradient_func, function, initial_point, max_learning_rate=0.999, min_learning_rate=0.001, 
                      beta1=0.89, beta2=0.895, epsilon=1e-8, max_iter=250, tol=1e-8):
